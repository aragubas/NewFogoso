...
{
    public class JumpToStart : TaiyouCommand
    {
        public JumpToStart(string[] pArguments, string pScriptCaller, TaiyouLine pRootTaiyouLine)
        {
        ...
        public override object Call()
        {
            ...
            return ReturnCodes.RoutineJumpStart;
        }
