...
namespace Fogoso.GameLogic.TextBox
{
    /// <summary>
    ...
    public static class KeyboardInput
    {
        ...
        public static event CharEnteredHandler CharPressed = new CharEnteredHandler(NullEventCharHandler);

        public static event KeyEventHandler KeyPressed = new KeyEventHandler(NullEventHandler);
        public static event KeyEventHandler KeyDown = new KeyEventHandler(NullEventHandler);

        private static void NullEventHandler(object sender, KeyEventArgs e, KeyboardState ks)
        {
            
        }
        private static void NullEventCharHandler(object sender, CharacterEventArgs e, KeyboardState ks)
        {
