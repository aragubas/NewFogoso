...
namespace Fogoso.GameLogic.TextBox
{
    public class TextBox
    {
        ...
        public event EventHandler<KeyboardInput.KeyEventArgs> EnterDown = new EventHandler<KeyboardInput.KeyEventArgs>(Ceira);

        private static void Ceira(object sender, KeyboardInput.KeyEventArgs e)
        {
